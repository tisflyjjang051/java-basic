...
public class GamePanel extends JPanel implements Runnable {
  ...
  Image bg = new ImageIcon("coin-ethan/img/smw-bg-hills.png").getImage();
  Image coin = new ImageIcon("coin-ethan/img/coin.png").getImage();
  Image mario = new ImageIcon("coin-ethan/img/super-mario.png").getImage();
  Image mushroom = new ImageIcon("coin-ethan/img/mushroom.png").getImage();
  Image shell = new ImageIcon("coin-ethan/img/pngegg.png").getImage();
